...
class MobileNetV2(nn.Module):
    def __init__(
        ...
        Args:
            ...
            first_conv_stride: Stride for first convolutional layer in mobilenet stem.
        ...
        features: List[nn.Module] = [
            ConvBNReLU(
                3, input_channel, stride=first_conv_stride, norm_layer=norm_layer, activation_layer=activation_layer
            )
        ]
